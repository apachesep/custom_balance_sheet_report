...
class account_move_line(osv.osv):
    ...
    def _query_get(self, cr, uid, obj='l', context=None):
        ...
        if context.get('without_con', False) and context['fiscalyear'] and len(context['fiscalyear']) == 1:
            fiscalyear_clause = context['fiscalyear'] and context['fiscalyear'][0]
        if context.get('without_con', False) and len(context['fiscalyear']) > 1:
            if fiscalyear_ids:
                fiscalyear_clause = tuple(fiscalyear_ids[0])
            else:
               fiscalyear_clause = '0' 
